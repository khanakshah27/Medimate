...
def med_analysis():
    try:
        prompt = f"""Based on the following medicine names: {text}, identify the disease(s) or medical conditions they are commonly used to treat.Then, provide a detailed explanation of the condition(s), including:
- What it is
- Common symptoms
- Causes
